/*
g++ -fcoroutines -std=c++20 -Wall -Werror coroutine.cc
clang++ -std=c++20 -stdlib=libc++ -fcoroutines-ts -Wall -Werror coroutine.cc
*/
...
void main3() {
    ...
    const ReturnObject3::promise_type &promise = h.promise();
    for (int i = 0; i < 3; ++i) {
...
struct ReturnObject4 {
    struct promise_type {
        ...
        ReturnObject4 get_return_object() { return {.h_ = std::coroutine_handle<promise_type>::from_promise(*this)}; }
        std::suspend_never initial_suspend() { return {}; }
        std::suspend_never final_suspend() noexcept { return {}; }
        void unhandled_exception() { }
...
struct ReturnObject5 {
    struct promise_type {
        ...
        ReturnObject5 get_return_object() { return {.h_ = std::coroutine_handle<promise_type>::from_promise(*this)}; }
        std::suspend_never initial_suspend() { return {}; }
